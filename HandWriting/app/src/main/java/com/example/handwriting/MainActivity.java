...
public class MainActivity extends AppCompatActivity {
    ...
    String[] kurdishLabel = {"ئ", "ا", "ب", "پ", "ت", "ج", "چ", "ح", "خ", "د", "ر", "ڕ", "ز", "ژ", "س", "ش", "ع", "غ", "ف", "ق", "ڤ", "ک", "گ", "ل", "ڵ", "م", "ن", "هه", "ە", "و", "وو", "ۆ", "ی", "ێ", "ص"};
...
//        TextView myTextView3 = findViewById(R.id.text_view_result);
...
//    }
    ...
    private void runInferenceOnFloatModel(ByteBuffer byteBufferToClassify) {
        try {
            float[][] outputVal = new float[1][35];
...
//        String s = kurdishLabel[byteBuffer];
